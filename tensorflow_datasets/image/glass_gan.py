...
# _DL_URL = "https://people.eecs.berkeley.edu/~taesung_park/GlassGan/datasets/"
...
class GlassGanConfig(tfds.core.BuilderConfig):
  """BuilderConfig for GlassGan."""

  @api_utils.disallow_positional_args
  def __init__(self, data=None, **kwargs):
    """Constructs a GlassGanConfig.
    ...
    super(GlassGanConfig, self).__init__(**kwargs)
    self.data = data


class GlassGan(tfds.core.GeneratorBasedBuilder):
  """GlassGan dataset."""

  BUILDER_CONFIGS = [
      GlassGanConfig(  # pylint: disable=g-complex-comprehension
          name=config_name,
  ...
  def _info(self):
    return tfds.core.DatasetInfo(
        ...
        urls=[
            "https://people.eecs.berkeley.edu/~taesung_park/GlassGan/datasets/"
        ],
    )
  ...
  def _split_generators(self, dl_manager):
    ...
    path_to_dataset = dl_manager.manual_dir
    print("manual_dir: {}".format(path_to_dataset))
